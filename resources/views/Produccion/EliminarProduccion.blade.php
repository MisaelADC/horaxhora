...
<head>
    ...
    <title>Eliminar Produccion</title>
...
<body>
    ...
    <div class="margen">
    <h1>Eliminar Produccion</h1>
    </div>

    <form class="row g-3 needs-validation" novalidate method="POST" action="/Produccion/{{$Produccion->IdProduction}}">
      @csrf
      @method("DELETE") 

      <div class="col-md-4">
        <label for="validationCustom01" class="form-label">Fecha</label>
        <input type="text" class="form-control" id="validationCustom01" value="{{$Produccion->Date}}"  readonly>
    </div>

    <div class="col-md-4">
      <label for="validationCustom01" class="form-label">Work Order</label>
      <input type="text" class="form-control" id="validationCustom01" value="{{$Produccion->Wo}}"  readonly>
  </div>

    <div class="col-md-4">
        <label for="validationCustom01" class="form-label">Meta de Produccion</label>
        <input type="text" class="form-control" id="validationCustom01" value="{{$Produccion->Meta}}"  readonly>
    </div>

    <div class="col-md-4">
      <label for="validationCustom01" class="form-label">Produccion Real</label>
      <input type="text" class="form-control" id="validationCustom01" value="{{$Produccion->Real}}"  readonly>
  </div>

  <div class="col-md-4">
    <label for="validationCustom01" class="form-label">Merma</label>
    <input type="text" class="form-control" id="validationCustom01" value="{{$Produccion->Scrap}}"  readonly>
</div>

  <div class="col-md-4">
    <label for="validationCustom01" class="form-label">Cantidad de materia prima</label>
    <input type="text" class="form-control" id="validationCustom01" value="{{$Produccion->WeightKg}}"  readonly>
  </div>
  ...
  <div class="col-md-4">
    ...
    <input type="text" class="form-control" id="validationCustom01" value="{{$Produccion->Machine}}"  readonly>
  </div>

  <div class="col-md-4">
    <label for="validationCustom01" class="form-label">Turno</label>
    <input type="text" class="form-control" id="validationCustom01" value="{{$Produccion->Shift}}"  readonly>
  </div>
