...
<body>
    ...
    <form class="row g-3 needs-validation" method="POST" action="/GenerarExcelDetallado" onsubmit="startDownload(event)">
      @csrf
      @method("POST")
    ...
    <div class="col-md-6">
        ...
        <input type="text" class="form-control @error('Wo') is-invalid @enderror" id="validationCustom01" value="{{ old('Wo') }}" name="Wo">
        @error('Wo')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
    ...
    <div class="col-md-6">
        <label for="validationCustom01" class="form-label">Selecciona un Máquina/Mesa:</label>
        <select class="form-control @error('Maquina') is-invalid @enderror" id="Maquina" name="Maquina">
            <option value="">Seleccione un Maquina/Mesa</option>
      ...
      <center>
          <div class="col-12" style="margin-bottom: 50px">
              <button id="submitButton" class="btn btn-success" type="submit">Generar Excel</button>
          </div>
      </center>
