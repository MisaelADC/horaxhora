...
<body>
    ...
    <form class="row g-3 needs-validation" novalidate method="POST" action="/Usuarios/{{$User->IdUser}}">
      @csrf
      @method("DELETE") 

      <div class="col-md-4">
        <label for="validationCustom01" class="form-label">Codigo de empleado</label>
        <input type="text" class="form-control @error('CodeEmp') is-invalid @enderror" id="validationCustom01" value="{{$User->CodeEmp}}" name="CodeEmp" required>
    </div>

    <div class="col-md-4">
      <label for="validationCustom01" class="form-label">Nombre</label>
      <input type="text" class="form-control" id="validationCustom01" value="{{$User->Name}}"  name="Name" readonly>
  </div>
  ...
  <div class="col-md-4">
    ...
    @switch($User["Type"])
    @case(0)
        <input type="text" class="form-control" id="validationCustom01" value="Administrador"  name="Type" readonly>
        @break
    @case(1)
        <input type="text" class="form-control" id="validationCustom01" value="Multiarea"  name="Type" readonly>
        @break
    @case(2)
    <input type="text" class="form-control" id="validationCustom01" value="Operador"  name="Type" readonly>
        @break
    @case(3)
    <input type="text" class="form-control" id="validationCustom01" value="Empacador"  name="Type" readonly>
      @break
@endswitch
  </div>
