...
<head>
    ...
    <title>Nuevo Tiempo Trabajado</title>
...
<body>
    ...
    <form class="row g-3 needs-validation" method="POST" action="/TiempoTrabajado" enctype="multipart/form-data">
      @csrf
      @method("POST")
  ...
  <div class="col-md-6">
    ...
    <select class="form-control @error('Maquina') is-invalid @enderror" id="Maquina" name="Maquina">
        ...
        @foreach ($Maquinas as $Maq)
            <option value="{{ $Maq->IdMachine }}" {{ old('Usuario') == $Maq->IdMachine ? 'selected' : '' }}>
