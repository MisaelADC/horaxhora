...
<body>
    ...
    <form class="row g-3 needs-validation" method="POST" action="/Ciclos" enctype="multipart/form-data">
      @csrf
      @method("POST")
    ...
    <div class="col-md-4">
      ...
      <div class="col-md-4">
          <label for="validationCustom01" class="form-label">Duración en segundos</label>
          <input type="number" class="form-control @error('Duracion') is-invalid @enderror" id="validationCustom01" value="{{ old('Duracion') }}" name="Duracion" required>
          @error('Duracion')
              <div class="invalid-feedback">
                  {{ $message }}
              </div>
