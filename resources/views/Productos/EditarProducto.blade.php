...
<body>
    ...
    <form class="row g-3 needs-validation" method="POST" action="/Productos/{{$Producto->IdProduct}}" enctype="multipart/form-data" novalidate>
      @csrf
      @method("PUT")
      <div class="col-md-6">
        <label for="validationCustom01" class="form-label">Codigo del producto</label>
        <input type="text" class="form-control @error('Codigo') is-invalid @enderror" id="validationCustom01" value="{{$Producto->ItemCode}}" name="Codigo" required>
        @error('Codigo')
  ...
  <div class="col-md-6">
    ...
    <input type="Number" class="form-control" id="validationCustom01" value="{{$Producto->Cycle}}"  name="Ciclo" required>
    @error('Ciclo')
    <div class="invalid-feedback">
        {{ $message }}
    </div>
@enderror
    ...
    <div class="col-md-8">
        ...
        <input type="text" class="form-control" id="validationCustom01" value="{{$Producto->Description}}"  name="Descripcion" required>
        @error('Descripcion')
        <div class="invalid-feedback">
            {{ $message }}
        </div>
