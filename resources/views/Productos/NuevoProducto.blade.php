...
<body>
    ...
    <form class="row g-3 needs-validation" method="POST" action="/Productos" enctype="multipart/form-data">
      @csrf
      @method("POST")
    ...
    <div class="col-md-6">
      ...
      <input type="Number" class="form-control @error('Ciclo') is-invalid @enderror" id="validationCustom01" value="{{ old('Ciclo') }}" name="Ciclo" required>
      @error('Ciclo')
          <div class="invalid-feedback">
              {{ $message }}
          </div>
