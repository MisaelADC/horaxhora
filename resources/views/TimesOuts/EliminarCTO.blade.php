...
<body>
    ...
    <form class="row g-3 needs-validation" method="POST" action="/TimeOut/{{$CTO->IdTimeOut}}">
      ...
      <input type="text" class="form-control" id="validationCustom01" value="{{$CTO->StartTime}}"  readonly>
      </div>

      <div class="col-md-4">
        <label for="validationCustom01" class="form-label">Final</label>
        <input type="text" class="form-control" id="validationCustom01" value="{{$CTO->EndTime}}"  readonly>
      </div>

      @if(!empty($CTO->user->Name))
      <div class="col-md-4">
        <label for="validationCustom01" class="form-label">Empleado</label>
        <input type="text" class="form-control" id="validationCustom01" value="{{$CTO->user->Name}}"  readonly>
      </div>
      @else
      <div class="col-md-4">
        <label for="validationCustom01" class="form-label">Empleado</label>
        <input type="text" class="form-control" id="validationCustom01" value="No disponible"  readonly>
      </div>
      @endif
      ...
      <div class="col-md-12">
        ...
        <input type="text" class="form-control"  id="validationCustom01" value="{{$CTO["downtimeReason"]["Reason"]}}"  readonly>
      </div>
      @else
      <div class="col-md-12">
        <label for="validationCustom01" class="form-label">Descripcion</label>
