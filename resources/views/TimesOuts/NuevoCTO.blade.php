...
<body>
    ...
    <form class="row g-3 needs-validation" method="POST" action="/TimeOut">
      @csrf
      @method("POST")
      ...
      <div class="col-md-12">
        ...
        <input type="text" class="form-control @error('Descripcion') is-invalid @enderror" id="validationCustom01" value="{{ old('Descripcion') }}" name="Descripcion" required>
        @error('Descripcion')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
    ...
    <input type="text" value="{{session("CTO")}}" name="IdProduccion" hidden>
