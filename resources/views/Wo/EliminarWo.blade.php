...
<body>
    ...
    <form class="row g-3 needs-validation" novalidate method="POST" action="/Wo/{{$Wo->IdWo}}">
      @csrf
      @method("DELETE") 

    <div class="col-md-4">
        <label for="validationCustom01" class="form-label">Work order</label>
        <input type="text" class="form-control" id="validationCustom01" value="{{$Wo->Wo}}"   readonly>
    </div>

    <div class="col-md-4">
      <label for="validationCustom01" class="form-label">Meta de tapetes</label>
      <input type="text" class="form-control" id="validationCustom01" value="{{$Wo->Meta}}"   readonly>
    </div>

    <div class="col-md-12">
      <label for="validationCustom01" class="form-label">Producto</label>
      <input type="text" class="form-control" id="validationCustom01" value="{{$Wo->product->Description}}"   readonly>
  </div>
