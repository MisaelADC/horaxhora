...
<body>
    ...
    <div class="margen" style="display: flex">
      <h1>Editar Diseño</h1>
      <a href="/Diseño/{{$Diseño->IdProduct}}" class="NuevoTabla">Regresar</a>
    </div>

    <form class="row g-3 needs-validation" method="POST" action="/Diseño/{{$Diseño->IdDesign}}" enctype="multipart/form-data" novalidate>
      @csrf
      @method("PUT")
    ...
    <div class="col-md-6">
        ...
        <input type="text" class="form-control" id="validationCustom01" value="{{$Diseño->Name}}"  name="Nombre" required>
        @error('Nombre')
    ...
    <center><img src="{{asset($Diseño["Image"])}}" style="width: 80px" alt=""> </center>
