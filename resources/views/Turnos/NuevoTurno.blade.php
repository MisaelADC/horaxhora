...
<body>
    ...
    <form class="row g-3 needs-validation" method="POST" action="/Turnos" enctype="multipart/form-data">
      @csrf
      @method("POST")

      <div class="col-md-4">
          <label for="validationCustom01" class="form-label">Nombre del turno</label>
          <input type="text" class="form-control @error('Turno') is-invalid @enderror" id="validationCustom01" value="{{ old('Turno') }}" name="Turno" required>
          @error('Turno')
      ...
      <div class="col-md-4">
        <label for="validationCustom01" class="form-label">Hora Inicial</label>
    ...
    <div class="col-md-4">
        <label for="validationCustom01" class="form-label">Hora Final</label>
