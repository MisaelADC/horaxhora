...
<body>
    ...
    <form class="row g-3 needs-validation" method="POST" action="/Turnos/{{$Turno->IdShift}}" enctype="multipart/form-data" novalidate>
      @csrf
      @method("PUT")
  
      <div class="col-md-4">
        <label for="validationCustom01" class="form-label">Turno</label>
        <input type="text" class="form-control @error('Turno') is-invalid @enderror" id="validationCustom01" value="{{$Turno->Shift}}" name="Turno" required>
    </div>

    <div class="col-md-4">
      <label for="validationCustom01" class="form-label">Hora de inicio</label>
      <input type="time" class="form-control" id="validationCustom01" value="{{$Turno->StartTime}}"  name="Inicio" required>
  </div>

    <div class="col-md-4">
        <label for="validationCustom01" class="form-label">Hora de final</label>
        <input type="time" class="form-control" id="validationCustom01" value="{{$Turno->EndTime}}"  name="Final" required>
    </div>
