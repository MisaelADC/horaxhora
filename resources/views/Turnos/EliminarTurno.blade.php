...
<body>
    ...
    <form class="row g-3 needs-validation" novalidate method="POST" action="/Turnos/{{$Turno->IdShift}}">
      @csrf
      @method("DELETE") 

      <div class="col-md-4">
        <label for="validationCustom01" class="form-label">Turno</label>
        <input type="text" class="form-control @error('Codigo') is-invalid @enderror" id="validationCustom01" value="{{$Turno->Shift}}"  readonly>
    </div>

    <div class="col-md-4">
      <label for="validationCustom01" class="form-label">Hora de inicio</label>
      <input type="text" class="form-control" id="validationCustom01" value="{{$Turno->StartTime}}"  readonly>
  </div>

    <div class="col-md-4">
        <label for="validationCustom01" class="form-label">Hora de salidax|</label>
        <input type="text" class="form-control" id="validationCustom01" value="{{$Turno->EndTime}}"  readonly>
    </div>
