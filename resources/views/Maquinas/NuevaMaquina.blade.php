...
<body>
  ...
  <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel" style="width: 180px;">
    ...
    <form class="row g-3 needs-validation" method="POST" action="/Maquinas" enctype="multipart/form-data">
      @csrf
      @method("POST")
      ...
      <div class="col-md-4">
          <label for="validationCustom01" class="form-label">Codigo de la Máquina</label>
