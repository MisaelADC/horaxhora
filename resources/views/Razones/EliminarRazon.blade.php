...
<body>
    ...
    <div class="margen">
    <h1>Eliminar Razon</h1>
    </div>

    <form class="row g-3 needs-validation" novalidate method="POST" action="/Razones/{{$Razon->IdDowntimeReason}}">
      @csrf
      @method("DELETE") 

    <div class="col-md-12">
        <label for="validationCustom01" class="form-label">Razon</label>
        <input type="text" class="form-control" id="validationCustom01" value="{{$Razon->Reason}}" readonly>
    </div>

    <div class="col-md-6">
      <label for="validationCustom01" class="form-label">Tipo</label>
      <input type="text" class="form-control" id="validationCustom01" value="{{$Razon->Tipo}}" readonly>
    </div>

  <div class="col-md-6">
    <label for="validationCustom01" class="form-label">¿Sustituto?</label>
    <input type="text" class="form-control" id="validationCustom01" value="{{$Razon->replacement}}" readonly>
  </div>
